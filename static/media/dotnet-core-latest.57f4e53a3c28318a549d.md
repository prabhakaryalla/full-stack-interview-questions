...
public class RequiredJsonPropertyAttribute : ValidationAttribute
{
    private readonly string _propertyName;

    public RequiredJsonPropertyAttribute(string propertyName)
    {
    ...
    {
        var json = validationContext.ObjectInstance;
        var jsonString = JsonSerializer.Serialize(json);
        using var doc = JsonDocument.Parse(jsonString);

        if (!doc.RootElement.TryGetProperty(_propertyName, out _))
        {
